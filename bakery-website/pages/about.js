      ...
      <div className="about-container">
        ...
        <div className="story-section">
          <p className="text-lg mb-8">
            I welcome everyone on this journey & experience known as Sweethearts. A Nashville Bakery taking on the task of spreading LOVE and MEMORIES around the WORLD, one handcrafted dessert at a time.
          </p>

          <p className="text-lg mb-8">
            I hope introducing myself will provide a glimpse of the hands, ideas, and dreams that manifest the SWEETS showcased here.
          </p>
          ...
          <div className="nashville-section">
            <h3 className="text-2xl mb-4 font-playfair">Nashville Journey</h3>
            <p className="text-lg mb-8">
              Over nine years ago, I moved to Nashville and had the privilege of working with Nashville Cares, helping process insurance claims, facilitating community meetings, drafting legislation, and bridging the gap between Nashville residents and the various departments of Metro Nashville.
            </p>

            <p className="text-lg mb-8">
              During the pandemic, I gained clarity on my direction and transitioned back to the kitchen. I had the opportunity to present bespoke desserts at Hillwood Country Club and Layer Cake, pioneered the banquet program, and created freely as The 404 Kitchen Executive Pastry Chef.
            </p>
          </div>
          ...
          <div className="closing-section">
            <p className="text-lg mb-8">
              Many thanks to the very many who have come before me, paved the way and fostered the creativity, authenticity, and magic that I have been fortunate to harness. Stay tuned for the continued examples of why @itssweetrighthere.
            </p>

            <p className="text-xl font-playfair text-right">
              XOXO,<br />
              Teddy
            </p>
          </div>
